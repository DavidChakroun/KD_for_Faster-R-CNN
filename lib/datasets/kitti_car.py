...
class kitti_car(imdb):
    def __init__(self, image_set , devkit_path=None):
        imdb.__init__(self, 'kitti_car_' + image_set)
        self._image_set = image_set
        self._devkit_path = '../dataset_originaux/kitty_pascal/'
        self._data_path = '../dataset_originaux/kitty_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('../dataset_originaux/kitty_pascal', 'results', 'Main')
    ...
    def _do_python_eval(self, output_dir='output'):
        annopath = os.path.join(
            '../dataset_originaux/kitty_pascal/',
            'Annotations',
            '{:s}.xml')
