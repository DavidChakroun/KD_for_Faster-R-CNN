...
class foggyCityscape(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'foggyCityscape_' + image_set)
        self._image_set = image_set
        self._devkit_path = '../dataset_originaux/foggy_cityscape_pascal/'
        self._data_path = '../dataset_originaux/foggy_cityscape_pascal/'
    ...
    def _load_pascal_annotation(self, index):
        ...
        for ix, obj in enumerate(objs):
            ...
            print(index)
            assert x2 > 0 and x2 <= w, print("x2 should > 0",x2)
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/foggy_cityscape_pascal', 'results', 'Main')
