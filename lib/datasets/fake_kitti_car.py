...
class fake_kitti_car(imdb):
    def __init__(self, image_set , devkit_path=None):
        imdb.__init__(self, 'fake_kitti_car_' + image_set)
        self._image_set = image_set
        self._devkit_path = 'data/fake_kitti_pascal/'
        self._data_path = 'data/fake_kitti_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/fake_kitti_pascal', 'results', 'Main')
