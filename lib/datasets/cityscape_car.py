...
class cityscape_car(imdb):
    def __init__(self, image_set):
        ...
        self._devkit_path = '../dataset_originaux/cityscape_pascal/'
        self._data_path = '../dataset_originaux/cityscape_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/cityscape_pascal', 'results', 'Main')
    ...
    def _do_python_eval(self, output_dir='output'):
        annopath = os.path.join(
            '../dataset_originaux/cityscape_pascal/',
            'Annotations',
            '{:s}.xml')
