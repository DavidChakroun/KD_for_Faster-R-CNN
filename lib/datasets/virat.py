...
class virat(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'virat_' + image_set)
        self._image_set = image_set
        self._devkit_path = '../dataset_originaux/viratPascal/'
        self._data_path = '../dataset_originaux/viratPascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/viratPascal', 'results', 'Main')
