...
class sim10k_car(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'sim10k_car_' + image_set)
        self._image_set = image_set
        self._devkit_path = '../dataset_originaux/SIM10K/'
        self._data_path = '../dataset_originaux/SIM10K/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('../dataset_originaux/SIM10K/', 'results', 'Main')
