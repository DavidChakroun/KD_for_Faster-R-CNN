...
class mot20(imdb):
    def __init__(self, image_set , devkit_path=None):
        imdb.__init__(self, 'mot20_' + image_set)
        self._image_set = image_set
        self._devkit_path = 'data/MOT20_pascal/'
        self._data_path = 'data/MOT20_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/MOT20_pascal', 'results', 'Main')
