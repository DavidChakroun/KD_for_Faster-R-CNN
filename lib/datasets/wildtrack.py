...
class wildtrack(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'wildtrack_' + image_set)
        self._image_set = image_set
        self._devkit_path = 'data/Wildtrack_pascal/'
        self._data_path = '../dataset_originaux/Wildtrack_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/Wildtrack_pascal', 'results', 'Main')
