...
class videowave(imdb):
    def __init__(self, image_set):
        imdb.__init__(self, 'videowave_' + image_set)
        self._image_set = image_set
        self._devkit_path = '../dataset_originaux/videowave_pascal/'
        self._data_path = '../dataset_originaux/videowave_pascal/'
    ...
    def _get_voc_results_file_template(self):
        ...
        filedir = os.path.join('data/videowave_pascal', 'results', 'Main')
