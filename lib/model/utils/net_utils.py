...
class EFocalLoss(nn.Module):
    ...
    #         gamma(float, double) : gamma 0; reduces the relative loss for well classied  examples
    #         ( > .5)  utting more focus on hard,     misclassied examples
...
def vis_detections(im, class_name, dets, thresh=0.8):
    ...
    for i in range(np.minimum(60, dets.shape[0])):
